...
public class Concert  {
    //TODO add instance variables saving the tickets here.
    ...
    public Concert(){
        ...
        ConcertThreads conthreadManager = new ConcertThreads(this);
       // conthreadManager.run();
    ...
    private void Initialization(){
        ...
        if (configurationFileReader!= null) {
            try {
                ...
                Tickets[i]=Integer.valueOf(temp[1]);		                              //Initialize the tickets with the value given in file
               
                // concertAdd = line;
                System.out.println("Tickets on the day"+i+"  " +Tickets[i]);
                }
